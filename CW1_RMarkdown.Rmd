...
Brentwood_complete_covid_data <-covid_data %>%
  ...
  # mutates specimen_date from date to character in order to joint table in 
  # question 3.3
...
a left join. With day_before being equal to specimen_date. Then a new column is 
added showing the daily percentage change of cases. Stored in a variable 
