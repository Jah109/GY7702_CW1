...
1. converting column specimen_date in *Brentwood_complete_covid_data*
+ this resulted in an error when attempted to convert the date to character as specified by the question in the table *Brentwood_day_before* 
2. Making a new table *Brentwood_complete_covid_data_converted* before the table join
+ This was successful in enabling the table join 
+ However it is a messy way round of executing this column data type conversion 
