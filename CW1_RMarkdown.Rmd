...
survey_responses %>%
  ...
  # as checking for specific values, 0 will be FALSE  
...
* To find a northern local authority district with similar population (~77,032) to Brentwood (my assigned area) 
* Compare the rate of change in COVID19 Cases 
